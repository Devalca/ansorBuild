...
NamaWilayah namaWilayahFromJson(String str) =>
    NamaWilayah.fromJson(json.decode(str));
...
DetailPdam detailPdamFromJson(String str) =>
    DetailPdam.fromJson(json.decode(str));
...
DetailTrans detailTransFromJson(String str) =>
    DetailTrans.fromJson(json.decode(str));
...
class DetailTrans {
  ...
  factory DetailTrans.fromJson(Map<String, dynamic> json) => DetailTrans(
        data: List<PdamTrans>.from(
            json["data"].map((x) => PdamTrans.fromJson(x))),
        message: json["message"],
      );
