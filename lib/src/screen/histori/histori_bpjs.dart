...
class HistoriBpjsPage extends StatefulWidget {
  final String headUrl;
  final String jenis;
  HistoriBpjsPage(this.headUrl, this.jenis);

  @override
  _HistoriBpjsPageState createState() => _HistoriBpjsPageState();
}

class _HistoriBpjsPageState extends State<HistoriBpjsPage> {
