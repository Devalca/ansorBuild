...
class HistoriPlnPage extends StatefulWidget {
  final String headerUrl;
  HistoriPlnPage(this.headerUrl);

  @override
  _HistoriPlnPageState createState() => _HistoriPlnPageState();
}

class _HistoriPlnPageState extends State<HistoriPlnPage> {
