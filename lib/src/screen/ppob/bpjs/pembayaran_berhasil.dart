                              ...
                              Container(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Center(
                                      child: Text(tanggal(createdAt) + ", " + DateFormat('HH:mm').format(createdAt), textAlign: TextAlign.center, style: new TextStyle(fontSize: 12.0)),
                                    ),
                                            ...
                                            Expanded(
                                              child: Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Container(
                                                    child: Text(snapshot.data.data[0].namaPelanggan, style: new TextStyle(fontSize: 12.0)),
                                                  ),
                                                ],
                                              ),
                                            ),
                                            ...
                                            Expanded(
                                              child: Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Container(
                                                    child: Text(snapshot.data.data[0].noVa.toString(), style: new TextStyle(fontSize: 12.0)),
                                                  ),
                                                ],
                                              ),
                                            ),
                                            ...
                                            Expanded(
                                              child: Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Container(
                                                    child: Text(tanggal(periode).substring(1), style: new TextStyle(fontSize: 12.0)),
                                                  ),
                                                ],
                                              ),
                                            ),
                                            ...
                                            Expanded(
                                              child: Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Container(
                                                    child: Text(snapshot.data.data[0].jumlahKeluarga.toString(), style: new TextStyle(fontSize: 12.0)),
                                                  ),
                                                ],
                                              ),
                                            ),
                                            ...
                                            Expanded(
                                              child: Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Container(
                                                    child: Text(snapshot.data.data[0].noTransaksi.toString(), style: new TextStyle(fontSize: 12.0)),
                                                  ),
                                                ],
                                              ),
                                            ),
                                            ...
                                            Expanded(
                                              child: Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Container(
                                                    child: Text(NumberFormat.simpleCurrency(locale: 'id', decimalDigits: 0).format(snapshot.data.data[0].total), style: new TextStyle(fontSize: 12.0)),
                                                  ),
                                                ],
                                              ),
                                            ),
